...
class __TwigTemplate_3ae286fc9cf6c6bfb85e65b43e2d4342698845f3143046beeeb49cebcf57a5d8 extends Template
{
    private $source;
    private $macros = [];
  ...
  <ul>
    ";
      ...
      <li>";
            ...
            echo " / ";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["user"], "isVerified", [], "any", false, false, false, 14), "html", null, true);
            echo " / ";
...
";
    ...
    {
        return array (  130 => 17,  115 => 14,  112 => 13,  108 => 12,  104 => 10,  95 => 8,  91 => 7,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block body %}
  ...
  <ul>
    {% for user in users %}
      ...
      <li>{{user.id}} / {{user.email}} / {{user.isVerified}} / {{user.password}}</li>
...
{% endblock %}
", "home/index.html.twig", "/home/christophe/Bureau/user_demo/templates/home/index.html.twig");
    }
}
